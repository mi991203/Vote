<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="MyWeb.AdminLogin" %>
                            ...
                            <td class="td-left" valign="top">
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <%--<tr>
                                        ...
                                        <td>
                                            <span style="color:#555">还没有账号？</span><a href="AdminRegister.aspx" style="text-decoration:none;"><span style="color:red;">去注册</span></a>
                                        </td>
                                    </tr>--%>
                                    <tr>
                                        <td class="td-title" valign="top"></td>
                                        <td>
                                            <span style="color:#555">用户登陆入口：</span><a href="Login.aspx" style="text-decoration:none;"><span style="color:red;">用户登录</span></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="td-title"></td>
